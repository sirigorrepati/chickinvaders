...
# Background
background = pygame.image.load('backestground (1).png')


# Sound
mixer.music.load('251287__djgriffin__135-ravey-game-loop-3.wav')
mixer.music.play(-1)
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                if bullet_state is "ready":
                    bulletSound = mixer.Sound("93569__steveygos93__waterballoon.wav")
                    bulletSound.play()
